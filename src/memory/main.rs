...
use async_openai::types::{
    ChatCompletiowenMessageToolCall, ChatCompletionRequestAssistantMessageArgs,
...
fn create_memory(memory: &str, _: &str) -> serde_json::Value {
...
fn update_memory(memory_id: &str, new_memory: &str) -> serde_json::Value {
    let memory_info = json!({
        "status": "success",
        "memory_id": memory_id,
...
fn delete_memory(memory_id: &str, _: &str) -> serde_json::Value {
    let memory_info = json!({
        "status": "success",
        "memory_id": memory_id,
